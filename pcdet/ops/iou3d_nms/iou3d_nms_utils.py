...
def pair_wise_boxes_iou3d_gpu(boxes_a, boxes_b):
    """
    Args:
        boxes_a: (N, 7) [x, y, z, dx, dy, dz, heading]
    ...
    # bev overlap
    overlaps_bev = boxes_a.new_zeros(boxes_a.shape[0])  # (N,)
    iou3d_nms_cuda.pair_wise_boxes_overlap_bev_gpu(boxes_a.contiguous(), boxes_b.contiguous(), overlaps_bev)
