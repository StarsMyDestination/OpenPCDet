...
class CTResNetNeck(BaseModule):
    ...
    def __init__(self, model_cfg, input_channels, init_cfg=None, **kwargs):
        super(CTResNetNeck, self).__init__(init_cfg)

        num_deconv_filters = model_cfg.NUM_DECONV_FILTERS
        num_deconv_kernels = model_cfg.NUM_DECONV_KERNELS
        use_dcn = model_cfg.USE_DCN
        ...
        self.num_2d_features = num_deconv_filters[-1]
